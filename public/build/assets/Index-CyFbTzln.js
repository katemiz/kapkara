  ...
  Layout($$anchor, {
    children: ($$anchor2, $$slotProps) => {
      ...
      Title(node, {
        ...
        subtitle: "List of All Change Requests"
      });
      ...
      var node_6 = sibling(node_5, 2);
      {
        var consequent_1 = ($$anchor3) => {
          ...
          each(tbody, 21, () => $$props.crequests.data, index, ($$anchor4, crequest) => {
            var tr = root_5();
            var td = child(tr);
            var text = child(td);
            var td_1 = sibling(td);
            ...
            template_effect(
              ($0) => {
                set_text(text, `CR-${get(crequest).id ?? ""}`);
                set_text(text_1, get(crequest).title);
                set_text(text_2, $0);
                set_attribute(a_1, "href", `/pdm/crequest/${get(crequest).id ?? ""}`);
                set_attribute(a_2, "href", `/pdm/crequest/${get(crequest).id ?? ""}/edit`);
              },
              [
                () => findInArray(get(crequest).status, $$props.supportFixedData.status)
              ]
            );
            append($$anchor4, tr);
          });
        ...
        if_block(node_6, ($$render) => {
          if ($$props.crequests.data.length > 0) $$render(consequent_1);
...
//# sourceMappingURL=Index-CyFbTzln.js.map
