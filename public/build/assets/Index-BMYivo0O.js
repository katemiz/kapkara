import { H as user_effect, c as pop, d as push, o as set, a as if_block, n as delegated, q as get, b as append, k as child, g as sibling, r as state, j as from_html, G as router, v as delegate, C as each, t as template_effect, l as set_text, D as index, F as user_derived } from "./app-D1xHItXN.js";
import { h as html } from "./html-D-zttEU3.js";
import { a as set_attribute } from "./attributes-BBrSLZ4L.js";
import { b as bind_value } from "./input-DV9WvhAT.js";
import Layout from "./Layout-C5TGvOFh.js";
import { T as Title } from "./Title-B6GQ1EA4.js";
import { T as TableRecordsInfo, P as Paginate, S as Search, E as Eye } from "./TableRecordsInfo-Bz7Cmo7N.js";
...
import "./chevron-right-GqX3b4EK.js";
...
var root_4 = from_html(`<table class="table is-fullwidth"><thead><tr><th>ID</th><th>Name/Description</th><th>Specification</th><th>Actions</th></tr></thead><tbody></tbody></table>`);
var root_6 = from_html(`<div class="notification is-warning is-light">No materials exist</div>`);
var root_1 = from_html(`<section class="section min-height-screen"><!> <nav class="level is-mobile"><div class="level-left"><p class="buttons"><a href="/pdm/material/create" class="button is-link"><span class="icon is-small"><!></span></a></p></div> <div class="level-right"><div class="control has-icons-right"><input class="input" type="text" placeholder="Search..."/> <!></div></div></nav> <!> <!> <!></section>`);
function Index($$anchor, $$props) {
  ...
  Layout($$anchor, {
    children: ($$anchor2, $$slotProps) => {
      ...
      Title(node, { title: "Material", subtitle: "List of All Materials" });
      ...
      var node_6 = sibling(node_5, 2);
      {
        var consequent_1 = ($$anchor3) => {
          ...
          each(tbody, 21, () => $$props.materials.data, index, ($$anchor4, material) => {
            var tr = root_5();
            var td = child(tr);
            var text = child(td);
            var td_1 = sibling(td);
            ...
            html(td_2, () => get(material).specification, true);
            ...
            template_effect(() => {
              set_text(text, get(material).id);
              set_text(text_1, get(material).description);
              set_attribute(a_1, "href", `/pdm/material/${get(material).id ?? ""}`);
              set_attribute(a_2, "href", `/pdm/material/${get(material).id ?? ""}/edit`);
            });
            append($$anchor4, tr);
          });
        ...
        if_block(node_6, ($$render) => {
          if ($$props.materials.data.length > 0) $$render(consequent_1);
...
//# sourceMappingURL=Index-BMYivo0O.js.map
