...
function Show($$anchor, $$props) {
  push($$props, true);
  let url = user_derived(() => window.location.origin + "/material/" + $$props.material.id);
  Layout($$anchor, {
    children: ($$anchor2, $$slotProps) => {
      ...
      Title(node, {
        get title() {
          return `Material ${$$props.material.id ?? ""}`;
        },
      ...
      var text = child(p);
      var p_1 = sibling(p, 2);
      html(p_1, () => $$props.material.remarks, true);
      var node_2 = sibling(p_1, 2);
      FilesList(node_2, {
        get media() {
          return $$props.material.files;
        }
      });
      ...
      template_effect(() => set_text(text, $$props.material.description));
...
//# sourceMappingURL=Show-Bm_YiVKi.js.map
