import { d as push, w as spread_props, x as comment, m as first_child, z as noop, b as append, c as pop, y as rest_props, p as prop, a as if_block, v as delegate, g as sibling, C as each, t as template_effect, l as set_text, q as get, n as delegated, k as child, D as index, j as from_html, G as router } from "./app-D1xHItXN.js";
import { I as Icon, s as snippet } from "./users-jlfJKlAC.js";
import { a as set_attribute } from "./attributes-BBrSLZ4L.js";
import { P as Plus } from "./plus-DM0mjF-b.js";
import { P as Pencil } from "./pencil-OM6xfdyP.js";
...
function Circle_x($$anchor, $$props) {
  ...
  Icon($$anchor, spread_props({ name: "circle-x" }, () => props, {
    get iconNode() {
      return iconNode;
    },
...
function Paperclip($$anchor, $$props) {
  ...
  Icon($$anchor, spread_props({ name: "paperclip" }, () => props, {
    get iconNode() {
      return iconNode;
    },
    children: ($$anchor2, $$slotProps) => {
...
function Save($$anchor, $$props) {
  ...
  Icon($$anchor, spread_props({ name: "save" }, () => props, {
    get iconNode() {
      return iconNode;
    },
    children: ($$anchor2, $$slotProps) => {
...
function Table_of_contents($$anchor, $$props) {
  ...
  Icon($$anchor, spread_props({ name: "table-of-contents" }, () => props, {
    get iconNode() {
      return iconNode;
    },
    children: ($$anchor2, $$slotProps) => {
...
function Trash($$anchor, $$props) {
  ...
  Icon($$anchor, spread_props({ name: "trash" }, () => props, {
    get iconNode() {
      return iconNode;
    },
    children: ($$anchor2, $$slotProps) => {
...
var root_2$1 = from_html(`<tr><td><!></td><td><button type="button" class="is-small has-text-link"><span> </span></button></td><td> </td><td> </td><td class="has-text-danger has-text-right"><button type="button" class="is-small is-danger is-clickable"><span class="icon is-small"><!></span></button></td></tr>`);
var root_1$1 = from_html(`<div class="card has-background-white-ter mt-4"><div class="card-content"><table class="table is-striped is-fullwidth"><caption class="mb-2"> </caption><tbody></tbody></table></div></div>`);
function FilesList($$anchor, $$props) {
  push($$props, true);
  let media = prop($$props, "media", 19, () => []);
  ...
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
      ...
      var tbody = sibling(caption);
      each(tbody, 21, media, index, ($$anchor3, file) => {
        var tr = root_2$1();
        var td = child(tr);
        var node_1 = child(td);
        Paperclip(node_1, { size: "16" });
        var td_1 = sibling(td);
        var button = child(td_1);
        ...
        Circle_x(node_2, { size: "16", color: "red" });
        template_effect(() => {
          set_text(text_1, get(file).name);
          set_text(text_2, get(file).mime);
          set_text(text_3, get(file).size);
        });
        delegated("click", button, () => downloadFile(get(file).url, get(file).name));
        delegated("click", button_1, () => deleteFile(get(file).id));
        append($$anchor3, tr);
      });
      template_effect(() => set_text(text, `Attachments [${media().length ?? ""} Files]`));
      append($$anchor2, div);
    };
    if_block(node, ($$render) => {
      if (media().length > 0) $$render(consequent);
    });
  }
...
const setInnerHtml = (elem, html) => {
  ...
  if (html) {
    ...
    if (head) {
      Array.from(head.childNodes).forEach((child2) => {
        elem.appendChild(child2);
      });
    }
    const body = parsed.querySelector("body");
    if (body) {
      Array.from(body.childNodes).forEach((child2) => {
        if (child2 instanceof HTMLVideoElement || child2 instanceof HTMLAudioElement) {
          elem.appendChild(child2.cloneNode(true));
        } else {
          elem.appendChild(child2);
        }
      });
...
const getDirectChildByClass = (elem, className) => {
  ...
  for (let i = 0; i < children.length; i++) {
    ...
    if (child2 instanceof HTMLElement && hasClass(child2, className)) {
      return child2;
    }
  }
};
...
const setFocus = (index2, increment) => {
  ...
  if (focusableElements.length) {
    ...
    if (isFirefox() && focusableElements[index2] instanceof HTMLIFrameElement) {
      return false;
    }
    return true;
  }
...
const handleArrows = (key) => {
  ...
  const sibling2 = arrowKeysNextButton.includes(key) ? "nextElementSibling" : "previousElementSibling";
  let buttonToFocus = document.activeElement;
  if (!buttonToFocus) {
    return;
  }
  for (let i = 0; i < actions.children.length; i++) {
    buttonToFocus = buttonToFocus[sibling2];
    if (!buttonToFocus) {
      return;
    }
...
var root$1 = from_html(`<button type="button" class="button is-danger has-text-white"><span class="icon"><!></span></button>`);
function DeleteButton($$anchor, $$props) {
  ...
  const confirmAndDelete = () => {
    Swal.fire({
      ...
      // Important to use custom classes
    }).then((result) => {
  ...
  var node = child(span);
  Trash(node, { size: "16" });
  delegated("click", button, confirmAndDelete);
  append($$anchor, button);
  pop();
}
delegate(["click"]);
var root_1 = from_html(`<nav class="level is-mobile"><div class="level-left"><p class="buttons"><a class="button is-link is-inverted is-outlined" data-tooltip="List All Materials"><span class="icon is-small"><!></span></a> <a class="button is-link is-inverted is-outlined"><span class="icon is-small"><!></span></a> <a class="button is-link is-inverted is-outlined"><span class="icon is-small"><!></span></a></p></div> <div class="level-right"><p class="buttons"><!></p></div></nav>`);
var root_3 = from_html(`<a class="button"><span class="icon"><!></span></a>`);
var root_4 = from_html(`<a class="button"><span class="icon"><!></span></a>`);
var root_2 = from_html(`<nav class="level is-mobile"><div class="level-left"><p class="buttons"><button type="submit" form="genericForm" class="button is-link is-inverted is-outlined"><span class="icon is-small"><!></span></button></p></div> <div class="level-right"><p class="buttons"><!></p></div></nav>`);
...
function ActionButtons($$anchor, $$props) {
  ...
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
      ...
      Table_of_contents(node_1, { size: "16" });
      var a_1 = sibling(a, 2);
      ...
      Pencil(node_3, { size: "16" });
      var div_1 = sibling(div, 2);
      var p_1 = child(div_1);
      var node_4 = child(p_1);
      DeleteButton(node_4, {
        get url() {
          return `/${$$props.route_name ?? ""}/${$$props.item.id ?? ""}`;
        }
      });
      template_effect(() => {
        set_attribute(a, "href", `/${$$props.route_name ?? ""}`);
        set_attribute(a_1, "href", `/${$$props.route_name ?? ""}/create`);
        set_attribute(a_1, "data-tooltip", `New ${$$props.route_name ?? ""}`);
        set_attribute(a_2, "href", `/${$$props.route_name ?? ""}/${$$props.item.id ?? ""}/edit`);
        set_attribute(a_2, "data-tooltip", `Edit this ${$$props.route_name ?? ""}`);
      });
      append($$anchor2, nav);
    };
    if_block(node, ($$render) => {
      if ($$props.form_type == "show") $$render(consequent);
    });
  }
  var node_5 = sibling(node, 2);
  {
    var consequent_2 = ($$anchor2) => {
      ...
      var node_7 = child(p_3);
      {
        var consequent_1 = ($$anchor3) => {
          ...
          X(node_8, { size: "16" });
          template_effect(() => set_attribute(a_3, "href", `/${$$props.route_name ?? ""}/${$$props.item.id ?? ""}`));
          append($$anchor3, a_3);
        };
        var alternate = ($$anchor3) => {
          var a_4 = root_4();
          var span_5 = child(a_4);
          var node_9 = child(span_5);
          X(node_9, { size: "16" });
          template_effect(() => set_attribute(a_4, "href", `/${$$props.route_name ?? ""}`));
          append($$anchor3, a_4);
        };
        if_block(node_7, ($$render) => {
          if ($$props.isEdit & $$props.item != null) $$render(consequent_1);
    ...
    if_block(node_5, ($$render) => {
      if ($$props.form_type == "form") $$render(consequent_2);
    });
  }
  append($$anchor, fragment);
  pop();
...
//# sourceMappingURL=ActionButtons-D_oA6R74.js.map
