...
class DocumentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $std = Document::create($theData);

        $this->spatieMultiple($request,$std);

        return redirect()->route('document.show', $std->id)
    ...
    {
        $doc = Document::findOrFail($idStandard);
    ...
    public function update(Request $request, $idDoc)
    {
        ...
        $this->spatieMultiple($request,$doc);

        $doc->update($theData);

        return redirect()->route('document.show', $doc->id)
