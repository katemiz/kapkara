...
class MyLibraryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $asset = MyAsset::create($theData);

        $this->spatieMultiple($request, $asset);

        return redirect()->route('mylib.show', $asset->id)
    ...
    {
        $asset = MyAsset::findOrFail($idAsset);

        $this->checkPermissions($asset);

        return Inertia::render('MyLib/Show', [
            'asset' => $asset,
    ...
    public function destroy($idAsset)
    {
        ...
        return redirect()->route('mylib.index')
    ...
    public function checkPermissions($asset)
    {
        // // Derive the permissions explicitly based on status
        // $this->permissions = match ($asset->status) {
        //     'DRAFT' => [
        //         'is_editable' => true,
        //         'is_freezable' => true,
        //         'is_releaseable' => true,
        ...
        $this->permissions['is_editable'] = $asset->created_by === auth()->id();
