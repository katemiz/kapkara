<script>
    ...
    let { ecns, filters, per_page, supportFixedData } = $props();
    ...
    <section class="section min-height-screen">
        ...
        <nav class="level is-mobile">
            ...
            <div class="level-left">
                <p class="buttons">
                    <a href="/pdm/ecn/create" class="button is-link">
        ...
        <TableRecordsInfo results={ecns} {per_page} />

        {#if ecns.data.length > 0}
                ...
                <tbody>
                    {#each ecns.data as ecn}
                        <tr>
                            ...
                            <td>
                                <a href="/pdm/ecn/{ecn.id}">
                                    <Eye size="24" />
                                </a>

                                <a href="/pdm/ecn/{ecn.id}/edit" class="ml-2"
                                    ><Pencil size="20" />
                                </a>
                            </td>
                        </tr>
