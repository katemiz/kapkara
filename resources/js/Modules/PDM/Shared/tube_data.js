...
export const tip_deflection_percentage = 2; // Percentage of extended height that the tip deflection is limited to


export const alum_6063_density = 2704; // kg/m³
export const alum_6063_E = 70e9; // Pa
export const alum_6063_yield_strength = 170e6; // Pa
export const alum_6063_ultimate_strength = 210e6; // Pa */




/*
    air_density:  kg/m3 see NASA https://www.earthdata.nasa.gov/topics/atmosphere/air-mass-density
    dynamic_viscosity_mu: Dynamic (kinetic) viscosity of air in kg/(m·s) at 20°C
    drag_coefficient_Cd: Dynamic (kinetic) viscosity of air in kg/(m·s) at 20°C
    tip_deflection_percentage: Percentage of extended height that the tip deflection is limited to
*/
